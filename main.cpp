...
int main(int argc, char *argv[])
{
    ...
    bool isFront = std::stoi(std::string(argv[6]));
    ////
    ...
    //    photographer.setInit(&myGeneralMeshTexture);
    ...
    //}
    //
    //std::string obj_full_path_test = obj_path + "Parsing" + obj_list[4];
    //std::string tex_full_path_test = tex_path + "color_map.jpg";

    //GeneralMeshTexture myGeneralMeshTextureTest(obj_full_path_test.c_str(), tex_full_path_test.c_str());

    //photographer.setInit(&myGeneralMeshTextureTest);
    //photographer.setShader(Shader::ShaderTypes::FULL_SHADER);
    //photographer.viewScene(true);
